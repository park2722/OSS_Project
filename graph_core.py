...
class CityGraph:
    City_pos = {"서울": (353., 205.), "파주": (332., 159.), "김포": (300., 180.), "인천": (312., 211.), "남양주": (393., 188.),
                ...
                "제주": (288., 832.), "고령":(537.,509.), "광양": (448.,629.), "구미": (546.,420.), "금산": (424.,440.), "남원":(414., 558.), "문경":(521.,338.), "부여":(339.,418), "양산":(644.,561.),
                "양양":(557.,117.), "양평":(429.,204), "여수":(446.,669.), "영암":(304.,667.), "영천":(630.,456.), "예산":(338.,349.), "원주":(481.,235.), "이천":(419.,245.),
                "정읍": (343.,528.), "창원":(584.,594.), "청도":(604.,521.), "평택":(358., 291), "함양":(608.,550.), "합천":(517.,534.)}
    def __init__(self):
        self.graph = {}
        self.adj = {}
